...
const DateTimePickerField: React.FC<Props> = ({ label, parentClassName = '', icon, className, name, ...props }) => {
	...
	return (
		<div>
			...
			<div className='flex items-center'>
				<Button type='button' className='bg-gray-darkless mr-2' onClick={() => setIsDatePickerOpen(true)}>
